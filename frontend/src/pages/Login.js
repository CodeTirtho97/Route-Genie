        ...
        <Box sx={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(to right, #FCEEB5, #FFDDC1)" }}>
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                <Paper sx={{ padding: "50px", width: "450px", textAlign: "center", borderRadius: "15px", boxShadow: "0px 6px 20px rgba(0, 0, 0, 0.15)", background: "#ffffff" }}>
                    ...
                    <TextField fullWidth label="Email" variant="outlined" sx={{ mb: 3, fontSize: "18px", background: "#fff", borderRadius: "5px" }} value={email} onChange={(e) => setEmail(e.target.value)} />
                    <TextField fullWidth label="Password" type="password" variant="outlined" sx={{ mb: 4, fontSize: "18px", background: "#fff", borderRadius: "5px" }} value={password} onChange={(e) => setPassword(e.target.value)} />
                    <Button fullWidth variant="contained" sx={{ backgroundColor: "#ff9800", "&:hover": { backgroundColor: "#ff5722" }, fontWeight: "bold", padding: "16px", fontSize: "18px" }} onClick={handleLogin}>
                        Login
                    </Button>
